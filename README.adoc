...
Self-signed certificate is automatically generated. `TLS_SAN` and `TLS_IP` environment variables are used to generate certificate with my CA (https://github.com/samisalkosuo/certificate-authority).
